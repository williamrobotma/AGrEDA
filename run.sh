...
jupyter nbconvert --ExecutePreprocessor.timeout=14400 --to notebook --inplace --execute reproduce_celldart.ipynb
./eval.py -d "data/preprocessed_markers_celldart" -n "CellDART" -v "bn_fix"
jupyter nbconvert --ExecutePreprocessor.timeout=14400 --to notebook --inplace --execute adda.ipynb
./eval.py -d "data/preprocessed_markers_standard" -n "ADDA" -v "Standard1"
jupyter nbconvert --ExecutePreprocessor.timeout=14400 --to notebook --inplace --execute dann.ipynb
