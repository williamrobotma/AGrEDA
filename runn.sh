...
./coral.py -f coral_pdac.yml -c 0
./eval_config.py --njobs 32 -f coral_pdac.yml -n CORAL -c 0

./coral.py -f coral.yml -c 0
./eval_config.py --njobs 32 -f coral.yml -n CORAL -c 0
