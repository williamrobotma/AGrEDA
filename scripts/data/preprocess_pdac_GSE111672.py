...
# %%
# pdac_a_indrop.obs["cell_subclass"].map(lambda x: x.rstrip(" AB")).value_counts()

# %%
# pdac_b_indrop.obs["cell_subclass"].map(lambda x: x.rstrip(" AB")).value_counts()
...
# %%
val_counts = indrop_out.obs["cell_subclass"].value_counts().reset_index()
val_counts["text"] = val_counts.apply(lambda x: f"{x['index']} ({x['cell_subclass']})", axis=1)

# %%
fig = plt.figure(figsize=(8, 8))

plt.pie(
    val_counts["cell_subclass"],
