...
./prep_data.py -s minmax --dset dlpfc --st_id spatialLIBD --sc_id GSE144136 --nmix 3 --samp_split --val_samp --nmarkers 40
./prep_data.py -s standard --dset dlpfc --st_id spatialLIBD --sc_id GSE144136 --nmix 10 --samp_split --val_samp --nmarkers 80
./prep_data.py -s standard --dset dlpfc --st_id spatialLIBD --sc_id GSE144136 --nmix 3 --samp_split --val_samp --nmarkers 80
./prep_data.py -s minmax --dset dlpfc --st_id spatialLIBD --sc_id GSE144136 --nmix 5 --samp_split --val_samp --nmarkers 40
...
for i in "${!ps_seeds[@]}"; do
    ...
    ./prep_data.py -s standard --dset dlpfc --st_id spatialLIBD --sc_id GSE144136 --nmix 3 --samp_split --val_samp --nmarkers 80 --ps_seed=$ps_seed
    ./prep_data.py -s minmax --dset dlpfc --st_id spatialLIBD --sc_id GSE144136 --nmix 5 --samp_split --val_samp --nmarkers 40 --ps_seed=$ps_seed
done
