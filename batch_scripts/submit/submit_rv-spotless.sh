...
mkdir -p logs/CellDART/generated_spotless1000
mkdir -p logs/CORAL/generated_spotless
mkdir -p logs/DANN/generated_spotless1000

GENCONFIG_JOBID=$(sbatch "batch_scripts/sbatch-gen-configs-spotless1000.sh" | tr -dc '0-9')
sleep 5
