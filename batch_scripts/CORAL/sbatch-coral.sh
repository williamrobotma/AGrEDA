...
#SBATCH --output=logs/CORAL/coral%N-%j.out
#SBATCH --error=logs/CORAL/coral%N-%j.err
...
python coral.py -f coral.yml
python eval_config.py --njobs -1 -f coral.yml -n CORAL
