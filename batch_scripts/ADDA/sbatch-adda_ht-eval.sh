...
# #SBATCH --output=logs/ADDA/generated/gen_v1-%a-eval-%N-%A.out
...
do
    ...
    ./eval_config.py -n ADDA -f "${config_file}" -cdir "configs/generated" --njobs=$SLURM_CPUS_PER_TASK -d "$SLURM_TMPDIR/tmp_results" --early_stopping
done
