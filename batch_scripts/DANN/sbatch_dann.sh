...
#SBATCH --output=logs/DANN/dann-evalonly%N-%j.out
...
# python -u dann.py -f "dann.yml" --njobs $num_workers
python -u eval_config.py -n "DANN" -f "dann.yml" --njobs $SLURM_CPUS_PER_TASK
